...
---
---
I am an AI Scientist + Social Scientist looking to build moral alignment _into_ AI. At the moment I am studying this in agent-based simulations (e.g. Multi-Agent RL with independent learners) and foundation models (e.g. Gemma), with inspiration from moral philosophy, psychology and economics. 
...
======
---
- [Oct 2024] New preprint out: Moral Alignment for LLM Agents [(see OpenReview)](https://openreview.net/pdf?id=MeGDmZjUXy)
